...
class TestRouterNode:
    ...
    @patch("src.agents.classifier")
    def test_lead_classification(self, mock_classifier, sample_lead_email, sample_state):
    ...
    @patch("src.agents.classifier")
    def test_complaint_classification(self, mock_classifier, sample_complaint_email, sample_state):
...
class TestWriterNode:
    ...
    def test_writer_generates_draft(self, mock_llm, sample_state):
    ...
    @patch("src.agents.llm")
    def test_writer_blocks_risky_content(self, mock_llm, sample_state):
...
class TestVerifierNode:
    ...
    @patch("src.agents.llm")
    def test_verifier_approves_good_draft(self, mock_llm, sample_state):
    ...
    @patch("src.agents.llm")
    def test_verifier_rejects_bad_draft(self, mock_llm, sample_state):
...
class TestSupportNode:
    ...
    @patch("src.agents.llm")
    def test_support_generates_apology(self, mock_llm, sample_complaint_email, sample_state):
